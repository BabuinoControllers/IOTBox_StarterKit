...
public class TestLao001 {
    ...
    DESCRIPTION: Create a Local Authentication(Admin) object and check the default value of the fields.
    ...
    DESCRIPTION: Create a Local Authentication (User) object and check the default value of the fields.
...
------------------------------------------------------------------------------*/
    public static void testCase06() throws TestException {
        ...
        try {
            ...
            //#
            //# Super A can Change the PIN , Old PIN verified. Status do not change. PIN Size Medium.
            //#
            ...
            //#
            //# Super A can Change the PIN , Old PIN verified. Status do not change. PIN Size Max.
            //#
            ...
            //#
            //# Admin changes the PIN, Old PIN verified. Status do not change. PIN Size Medium.
            //#
            ...
            //#
            //# Admin changes the PIN, Old PIN verified. Status do not change. PIN Size Max.
            //#
            ...
            //#
            //# User changes the PIN, Old PIN verified. Status do not change. PIN Size Medium.
            //#
            ...
            //#
            //# User changes the PIN, Old PIN verified. Status do not change. PIN Size Max.
            //#
...
------------------------------------------------------------------------------*/
    public static void testCase07() throws TestException {
        ...
        try {
            ...
            //#
            //# Super A can update the max retries of Admin Lao
            //#
    ...
    public static void testCase13() throws TestException {
        ...
        try {
            ...
            expectedRes = String.format("%02X", Atlv.DATA_TAG_RESPONSE) + "1A" +
                    String.format("%02X", Atlv.DATA_TRANSACTION_COUNTER_TAG) + "08????????????????" +
                    String.format("%02X", Atlv.DATA_TAG_APDU_RESPONSE) + "04" +
                    Apdu.SW_6A82_INCORRECT_PIN_NOT_INIT_TLV_STRING +
                    String.format("%02X", Atlv.DATA_TAG_MAC) + "08????????????????";
