...
public class TestUserMqttTLS001 {
    ...
    ********************************/
    ...
    public static final String certificate = "-----BEGIN CERTIFICATE-----\n" +
                                            "MIICiDCCAi2gAwIBAgIJAJ/7/yBaCfTcMAoGCCqGSM49BAMCMIGfMQswCQYDVQQG\n" +
                                            "EwJJVDELMAkGA1UECAwCTkExETAPBgNVBAcMCEFmcmFnb2xhMRwwGgYDVQQKDBNC\n" +
                                            "YWJ1aW5vIENvbnRyb2xsZXJzMTQwMgYDVQQLDCtCYWJ1aW5vIENvbnRyb2xsZXJz\n" +
                                            "IENlcnRpZmljYXRpb24gQXV0aG9yaXR5MRwwGgYDVQQDDBNCYWJ1aW5vIENvbnRy\n" +
                                            "b2xsZXJzMB4XDTE5MDcxNTE2MzQ0OVoXDTIxMDcxNDE2MzQ0OVowgZ8xCzAJBgNV\n" +
                                            "BAYTAklUMQswCQYDVQQIDAJOQTERMA8GA1UEBwwIQWZyYWdvbGExHDAaBgNVBAoM\n" +
                                            "E0JhYnVpbm8gQ29udHJvbGxlcnMxNDAyBgNVBAsMK0JhYnVpbm8gQ29udHJvbGxl\n" +
                                            "cnMgQ2VydGlmaWNhdGlvbiBBdXRob3JpdHkxHDAaBgNVBAMME0JhYnVpbm8gQ29u\n" +
                                            "dHJvbGxlcnMwWTATBgcqhkjOPQIBBggqhkjOPQMBBwNCAAQWy+JubswS1OvpmABk\n" +
                                            "Ml1HrZCw+inkQpTg4N63H5GT8v/JCJbmJVcQUIW0/7kofszMxbVnWtdSt5RWzP1c\n" +
                                            "vZkYo1AwTjAdBgNVHQ4EFgQU80Vtz5KSM9lwK9KtXEu9Da1xCf8wHwYDVR0jBBgw\n" +
                                            "FoAU80Vtz5KSM9lwK9KtXEu9Da1xCf8wDAYDVR0TBAUwAwEB/zAKBggqhkjOPQQD\n" +
                                            "AgNJADBGAiEAghTEPtxziiZUttYRf0LGYpu5TBEk4sXIg3dFNbGJBToCIQD4pqm0\n" +
                                            "x3JlqLt7V3EH8cg3Kpx2zxN+GG0taC7jR/z7hg==\n" +
                                            "-----END CERTIFICATE-----";

    //public static final String hostName =  "54.76.137.235"; //mqtt cloud
    // public static final int port =  18223; // mqtt cloud
    
    public static final String hostName =  "80.211.32.249"; //mqtt cloud
    ...
    {	
       ...
       Command.onError = Command.ALT_ON_ERROR;        
        ...
        try {
                ...
                InputStream inputStream = new ByteArrayInputStream(certificate.getBytes(Charset.forName("UTF-8")));
                Certificate ca = cf.generateCertificate(inputStream);
                inputStream.close();
                
                ConnectionDetailsTlsMqtt connectionDetails = new ConnectionDetailsTlsMqtt();
                
                connectionDetails.setBearer(ConnectionDetailsMqtt.BEARER_MQTT_TLS_OVER_ETHERNET);
                ...
                connectionDetails.setCertificate(ca);
        ...
        catch (TestException | IOException | CertificateException e){  
