       ...
       // ---------------------- Code -------------------------------        
        ...
        try {
                ...
                for (int u = 0; u<1; u++)
                {
                    ...
                    if (u == 0)
                    {
                   //     d = Device.discover(deviceId, Device.ETHERNET);
...
/*################################################################################################
  ...
  ################################################################################################*/
	...
	public static void testCase05() throws TestException
	{
                Command c = new Command();
                AccessPolicy ap;
                String a, inversion, alwaysPolicy, expectedRes;
                User admin, user;
...
/*################################################################################################
 ...
 /*################################################################################################
  ...
  ################################################################################################*/                    
                    ...
                    apdu = new Apdu(Apdu.DELETE_OBJECT_APDU);
                    apdu.addTlv(Apdu.DATA_TAG_OBJECT_ID, AccessPolicy.DEFAULT_ACCCESS_POLICY_ID);
